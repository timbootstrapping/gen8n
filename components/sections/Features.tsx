...
export default function Features() {
  return (
    <section id="features" className="py-10 px-4 sm:px-8 lg:px-20 space-y-12">
      <h2 className="text-center text-3xl font-semibold">Features</h2>
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map(({ title, description, icon: Icon }, idx) => (
          <div key={idx} className="p-6 border border-border rounded-2xl flex flex-col gap-4">
            <Icon size={32} strokeWidth={1} className="text-highlight" />
