      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-8 space-y-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {steps.map(({ icon, title, description }, index) => {
            return (
              <div key={index} className="group bg-[#18181b] rounded-2xl p-6 flex flex-col items-center text-center gap-6 transition-all duration-300 hover:shadow-[0_0_25px_rgba(139,92,246,0.2)] hover:scale-[1.02]">
                <div className="relative w-full max-w-xs mx-auto aspect-square rounded-2xl overflow-hidden">
                  <EvervaultCard>
                    <div className="relative flex items-center justify-center w-full h-full">
                      ...
                      <div className="z-10 group-hover:animate-icon-pulse-glow text-[#8b5cf6]">
